        ...
        <div className="absolute bottom-0 inset-x-0 h-80 pointer-events-none overflow-hidden">
          ...
          <svg className="absolute bottom-0 w-full h-full" viewBox="0 0 1400 320" preserveAspectRatio="none">
            <defs>
              ...
              {/* Lava flow gradient */}
              <linearGradient id="lavaFlow2" x1="0%" y1="100%" x2="0%" y2="0%">
                <stop offset="0%" stopColor="#ffeb3b" stopOpacity="1" />
              ...
              {/* Rock texture */}
              <linearGradient id="rockTexture2" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            {/* Lava pools at base */}
            <ellipse cx="200" cy="285" rx="35" ry="8" fill="url(#lavaGlow2)" opacity="0.9">
              <animate attributeName="opacity" values="0.7;1;0.7" dur="2s" repeatCount="indefinite" />
            </ellipse>
            <ellipse cx="520" cy="285" rx="45" ry="10" fill="url(#lavaGlow2)" opacity="0.9">
              <animate attributeName="opacity" values="0.8;1;0.8" dur="2.5s" repeatCount="indefinite" />
            </ellipse>
            <ellipse cx="900" cy="285" rx="38" ry="9" fill="url(#lavaGlow2)" opacity="0.9">
              <animate attributeName="opacity" values="0.75;1;0.75" dur="2.2s" repeatCount="indefinite" />
            </ellipse>
            <ellipse cx="1210" cy="285" rx="42" ry="10" fill="url(#lavaGlow2)" opacity="0.9">
              <animate attributeName="opacity" values="0.7;1;0.7" dur="2.8s" repeatCount="indefinite" />
            </ellipse>
            
            {/* Animated lava streams */}
            <path d="M 200 220 Q 198 250, 200 280" stroke="url(#lavaFlow2)" strokeWidth="4" fill="none" opacity="0.8">
              <animate attributeName="stroke-width" values="3;5;3" dur="1.5s" repeatCount="indefinite" />
              <animate attributeName="opacity" values="0.6;0.9;0.6" dur="1.5s" repeatCount="indefinite" />
            </path>
            <path d="M 520 200 Q 518 240, 520 280" stroke="url(#lavaFlow2)" strokeWidth="6" fill="none" opacity="0.85">
              <animate attributeName="stroke-width" values="4;7;4" dur="1.8s" repeatCount="indefinite" />
              <animate attributeName="opacity" values="0.7;1;0.7" dur="1.8s" repeatCount="indefinite" />
            </path>
            <path d="M 900 230 Q 898 255, 900 280" stroke="url(#lavaFlow2)" strokeWidth="4" fill="none" opacity="0.8">
            ...
            <path d="M 1210 210 Q 1208 245, 1210 280" stroke="url(#lavaFlow2)" strokeWidth="5" fill="none" opacity="0.85">
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-white/70 text-sm">
                Start your journey with Orca Ventures
              </p>
            </div>
          </div>
